...
public class Device {
	...
	public static Point2D.Double geoToPix(Point point) {
		double stscreenX = (point.x - ViewBaseInfo.centerPoint.x) / (p2x * ViewBaseInfo.curMapScale / 100) + widthPixels/2;
		double stscreenY = (ViewBaseInfo.centerPoint.y - point.y) / (p2y * ViewBaseInfo.curMapScale / 100) + heightPixels/2;
