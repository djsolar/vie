...
public class PetrolViewTeleParser extends BaseTeleParser {
	...
	public File getFilePath() {
		...
		if(sysname.equalsIgnoreCase("linux")){
			filePath = new File(Controller.drawParams.LinuxTeleFile + "/petrolview");
		}else{
			filePath = new File(Controller.drawParams.WindowsTeleFile + "/petrolview");
		}
		return filePath;
	}

	public PetrolViewTeleParser() {
		String sysname = System.getProperty("os.name");
		if(sysname.equalsIgnoreCase("linux")){
			filePath = new File(Controller.drawParams.LinuxTeleFile + "/petrolview");
		}else{
